  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="feedback" className="text-sm font-medium">Tell us how we did!</label>
                <textarea 
              ...
              <div>
                <label className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm">Allow this review to be shared publicly</span>
                </label>
              </div>
            </form>
          </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">Share your unique referral code with friends and earn rewards when they become customers!</p>
            ...
            <div className="bg-muted rounded-lg p-4 flex items-center justify-between">
              <div>
                <div className="text-xs text-muted-foreground">Referrals Earned</div>
              ...
              <div>
                <div className="text-xs text-muted-foreground">Pending Referrals</div>
