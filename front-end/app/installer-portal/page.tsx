  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-3xl font-bold tracking-tight">Installer Portal</h1>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div 
                  key={index}
                  className="flex flex-col gap-1 p-4 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer"
                >
          ...
          <CardContent>
            <form className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="jobId" className="text-sm font-medium">Select Job</label>
              ...
              <div className="space-y-2">
                <label htmlFor="photoType" className="text-sm font-medium">Photo Type</label>
                <select className="hive-input">
              ...
              <div className="grid w-full items-center gap-1.5">
                ...
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-muted-foreground/60 px-6 py-10">
                  <div className="text-center">
                    <svg className="mx-auto h-12 w-12 text-muted-foreground" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="mt-4 flex text-sm leading-6 text-muted-foreground">
                      <label htmlFor="file-upload" className="relative cursor-pointer rounded-md bg-background font-semibold text-primary focus-within:outline-none focus-within:ring-2 focus-within:ring-primary">
